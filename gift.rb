...
module Gift
  ...
  def _nt_short_answer_question
    ...
    if s0.last
      ...
      r0.extend(ShortAnswerQuestion1)
    else
      @index = i0
      r0 = nil
    end
  ...
  def _nt_mutiple_choice_question
    ...
    if s0.last
      ...
      r0.extend(MutipleChoiceQuestion1)
    else
      @index = i0
      r0 = nil
    end
  ...
  def _nt_description_question
    ...
    if s0.last
      ...
      r0.extend(DescriptionQuestion1)
    else
      @index = i0
      r0 = nil
    end
